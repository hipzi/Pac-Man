...
//	public static FOOD Available = FOOD.YES;
...
////								System.out.printf("food : %d %d%n", i, food.size());
////								System.out.printf("food : %d %d%n", food.get(i), food.size());
//								g.setColor(Color.LIGHT_GRAY);
//								g.fillOval(x * 32 + 15, y * 32 + 15, 4, 4);
//							}
//							food.get(x).render(g);
//							food.get(y).render(g);
//							System.out.printf("food : %d%n", food.size());
...
////								food.render(g);								
//								
////								System.out.printf("%d %d%n", actor.getTileX(), actor.getTileY());
////								System.out.printf("%d %d%n", food.getTileX(), food.getTileY());
//								
								if(actor.lastDir == 1) {
									for(l = 0; l < d; l++) {
...
////						Available = FOOD.NO;
//								
////								System.out.printf("Score : %d%n", food.score());
//							}
//					}
